                    ...
                    ?>
                        <tr>
                            <form action="assignar_incidencia.php" method="POST">
                                <td>
                                    <div class="p-3 border-start border-5 border-<?php echo $clase ?>"></div>
                                </td>
                                ...
                                <td>
                                    <select name="tecnic" class="form-select form-select-sm w-auto mx-auto" required>
                                ...
                                <td>
                                    <select name="prioritat" class="form-select form-select-sm w-auto" required>
...
<div class="mx-2 mb-5 mt-auto px-2">
    ...
    <a href="tecnic_stats.php" class="btn btn-info">Estadístiques per Tècnics</a>
</div>
