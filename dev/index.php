...
<header>
    <div class="container-fluid bg-black bg-gradient text-white p-2 shadow text-center">
        <div class="row align-items-center">
            ...
            <div class="col-md-8">
                <h1 class="display-5 fw-bold mb-2">Gestió de les teves incidències</h1>
            </div>
            <div class="col-md-2">
...
<main class="container d-flex pb-5 flex-column justify-content-center align-items-center" style="min-height: 70vh;">
